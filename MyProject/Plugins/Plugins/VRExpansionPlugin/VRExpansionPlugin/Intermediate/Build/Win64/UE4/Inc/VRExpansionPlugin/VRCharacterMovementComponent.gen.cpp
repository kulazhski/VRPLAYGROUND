...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UVRCharacterMovementComponent()
	{
		...
		if (!OuterClass)
		{
...
#endif
			auto NewProp_bUseClientControlRotation_SetBit = [](void* Obj){ ((UVRCharacterMovementComponent*)Obj)->bUseClientControlRotation = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bUseClientControlRotation = { UE4CodeGen_Private::EPropertyClass::Bool, "bUseClientControlRotation", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UVRCharacterMovementComponent), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bUseClientControlRotation_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bUseClientControlRotation_MetaData, ARRAY_COUNT(NewProp_bUseClientControlRotation_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bUseClientControlRotation,
	...
	IMPLEMENT_CLASS(UVRCharacterMovementComponent, 3333720435);
