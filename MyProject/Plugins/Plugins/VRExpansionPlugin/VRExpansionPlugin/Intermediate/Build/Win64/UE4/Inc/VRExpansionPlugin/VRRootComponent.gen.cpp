...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UVRRootComponent()
	{
		...
		if (!OuterClass)
		{
...
#endif
			auto NewProp_bAllowSimulatingCollision_SetBit = [](void* Obj){ ((UVRRootComponent*)Obj)->bAllowSimulatingCollision = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAllowSimulatingCollision = { UE4CodeGen_Private::EPropertyClass::Bool, "bAllowSimulatingCollision", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UVRRootComponent), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bAllowSimulatingCollision_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bAllowSimulatingCollision_MetaData, ARRAY_COUNT(NewProp_bAllowSimulatingCollision_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bAllowSimulatingCollision,
	...
	IMPLEMENT_CLASS(UVRRootComponent, 654373857);
